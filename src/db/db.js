...
const { Product, Category, Service, Bill, Client, ServiceDone, Stylist, Product_Bill, Stylist_Category, BillChange } = sequelize.models;
...
BillChange.belongsTo (Bill);
Bill.hasMany(BillChange);
